...
<?php  if (!isset($_POST['submit']))  {
          ...
          echo "fail";
            ...
            //If success
            $category_name = $_POST['menu_name'];
            $status = $_POST['status'];
            $sql = "INSERT INTO menu_items (`menu_name`,`status`) VALUES ('$category_name','$status')";
              ...
              <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                <form data-toggle="validator" method="post" enctype="multipart/form-data">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="form-control-2" name="menu_name" placeholder="Menu Name" data-error="Please enter Category Name." required>
